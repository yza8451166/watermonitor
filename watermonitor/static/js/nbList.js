...
//     };
        ...
        function initBody(table_config,data_list){
            ...
            for(var i=0;i<data_list.length;i++){
                ...
                var tr = document.createElement('tr');
                tr.setAttribute('row-id',row['nid']);
                ...
                $.each(table_config,function (i,colConfig) {
                   if(colConfig.display){
                       ...
                       console.log('dict',i,colConfig);
                       var td = document.createElement('td');
                       /* 生成文本信息 */

                       console.log('colConfig',colConfig);
                       var temp =colConfig["q"];
                       console.log('temp',temp);
                       var finalVal=row[temp];

                       console.log("final_val",finalVal);

                       var temp = colConfig.text.content;
                       ...
                       // console.log('colConfig.text.content1111111111111',colConfig.text.content);
                       // console.log('kwargs:',kwargs);
                       var xc ='abc';
                       console.log('prototype',xc.__proto__);
